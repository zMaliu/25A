...
% 2. 三个关键圆点
yval = interp1(t_vec, d2_vec, [1.5 3.6 20.1]);
...
plot(20.1, yval(3), 'o', 'Color', [0.60 0.40 0.90], 'MarkerSize', 7, ...
...
xlabel('时间 t (s)','FontSize', 15);
ylabel('烟幕中心到导弹-目标连线距离 d_2 (m)','FontSize', 15);
grid off;